...
SELECT name, ROUND(population/1000000.00, 2), ROUND(gdp/1000000000.00, 2) FROM world WHERE continent = 'South America'
...
SELECT name
FROM world
WHERE name NOT LIKE '% %' -- Excludes countries with spaces in the name
AND name LIKE '%a%' -- Must contain 'a'
AND name LIKE '%e%' -- Must contain 'e'
AND name LIKE '%i%' -- Must contain 'i'
AND name LIKE '%o%' -- Must contain 'o'
AND name LIKE '%u%'; -- Must contain 'u'
